...
system('curl '.escapeshellarg($url).' | '.SOX_PATH.' -t mp3 - -t wav - speed '.escapeshellarg($speed).' reverb 80 echo 0.8 0.9 1000.0 0.3 1800.0 0.25 2900.0 0.15 | '.LAME_PATH.' -b 72 --quiet - -');