...
//Available voices
$VOICES = array('fr','en');
$METHODS = array('concatenate', 'sequence', 'mix', 'mix-power', 'merge', 'multiply');
...
$method = isset($_REQUEST['method']) && in_array($_REQUEST['method'],$METHODS) ? $_REQUEST['method']:'mix';
...
system(SOX_PATH.' --combine '.escapeshellarg($method).' -v 1 '.escapeshellarg($tmpfname1).' -v 1 '.escapeshellarg($tmpfname2).' -t wav - | '.LAME_PATH.' --quiet - -');
exit();
